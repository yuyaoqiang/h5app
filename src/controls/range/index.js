  ...
  mounted: function mounted() {
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__draggable__["a" /* default */])(thumb, {
      ...
      drag: function (event) {
        ...
        var stepCount = (this$1.max - this$1.min) / this$1.step;//Math.ceil((this$1.max - this$1.min) / this$1.step);
        stepCount=stepCount.toFixed(1);
        ...
        var inputVal=(this$1.min + newProgress * (this$1.max - this$1.min)).toFixed(1);

        this$1.$emit('input',inputVal ); //Math.round(this$1.min + newProgress * (this$1.max - this$1.min))
      },
      end: function () {
        if (this$1.disabled) return;
