...
export  default {
    ...
    typeList:[
        ...
        {pid:1, id:2, name:'前三走势',routerName:'qsTrend', detailedList:['组选分布','大小比','奇偶比','质和比','号码类型']},
        {pid:1, id:3, name:'中三走势',routerName:'zsTrend', detailedList:['组选分布','大小比','奇偶比','质和比','号码类型']},
        {pid:1, id:4, name:'后三走势',routerName:'hsTrend', detailedList:['组选分布','大小比','奇偶比','质和比','号码类型']},
        // {pid:1, id:5, name:'三星组选走势',routerName:'sxzxTrend', detailedList:['组选分布','大小比','奇偶比','质和比','号码类型']},
        {pid:1, id:6, name:'二星组选走势',routerName:'exzxTrend', detailedList:['组选分布','大小比','奇偶比','质和比']},
        {pid:2, id:7, name:'五星和值走势',routerName:'wxhzTrend',  detailedList:['和值分布','和尾分布']},
        {pid:2, id:8, name:'三星和值走势',routerName:'sxhzTrend', detailedList:['和值分布','和尾分布']},
        {pid:2, id:9, name:'二星和值走势',routerName:'exhzTrend',detailedList:['和值分布','和尾分布']},
        {pid:3, id:10, name:'形态走势',routerName:'xtTrend',detailedList:['万位走势','千位走势','百位走势','十位走势','个位走势']},
        {pid:3, id:11, name:'振幅走势',routerName:'zfTrend',detailedList:['万位走势','千位走势','百位走势','十位走势','个位走势']},
        {pid:3, id:12, name:'三星跨度走势',routerName:'sxkdTrend',detailedList:['组选分布','跨度']},
        {pid:3, id:13,name:'二星和值走势',routerName:'exkdTrend',detailedList:['组选分布','跨度']},
