...
export default {
    ...
    getChatroomPlatformByToken(callback) {
        apiUtil.doPost("/Hongbao/platformurlH5.mvc", callback)
    },
    findDividendAndSignRecord(params, callback) {
        apiUtil.doPost("Hongbao/findDividendAndSignRecord.mvc", params, callback)
    },
    signActivity(params, callback) {
        apiUtil.doPost("Promotions/signActivity.mvc", params, callback)
    }
}
