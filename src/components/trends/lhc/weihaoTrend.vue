    ...
    export default {
        ...
        data () {
            return {
                ...
                drawInterval:null,
                cacheMap:{},
                columnNums:[['10-20-30-40'],['01-11-21-31-41'],['02-12-22-32-42'],
                    ['03-13-23-33-43'],['04-14-24-34-44'],['05-15-25-35-45'],['6-16-26-36-46'],
                    ['07-17-27-37-47'],['08-18-28-38-48'],['09-19-29-39-49']],
                dataArray:[]
            }
        },
        methods: {
            fillHead(){
                ...
                var columns = lhcUtil.getWeiNumbers();
