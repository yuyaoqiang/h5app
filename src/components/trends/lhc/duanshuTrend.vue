...
<script>
    ...
    export default {
        props: ['lottery','issueList','setting','removeOffsetHistoryEnd','selectType'],
        data () {
            return {
                missingNumList:[],
                dialogTrend: false,
                drawInterval:null,
                cacheMap:{},
                columnNums:[['01-02-03-04-05'],['06-07-08-09-10'],['11-12-13-14-15'],
        ...
        methods: {
            fillHead(){
                ...
                var columns = lhcUtil.getDuanNumber();
            ...
            getMissing: function (nums) {
                ...
                try {
                        var cnt = true;
                            if(arrayUtil.indexOf(fullNums,nums[0])!=-1){
                                this.cacheMap[0] = 0;
                                cnt = false;
                            }
                        if(cnt){
