    ...
    export default {
        ...
        data () {
            return {
                ...
                drawInterval:null,
                cacheMap:{},
                columnNums:[['01-02-07-08-12-13-18-19-23-24-29-30-34-35'],['03-04-09-10-14-15-20-25-26-31-36'],['05-06-11-16-17-21-22-27-28-32-33']],
                dataArray:[]
            }
        },
        methods: {
            fillHead(){
                ...
                var columns = xyxzUtil.getbose();
                this.dataArray = this.getColumnDate(columns);
                this.lottery.trendData.fullNums = this.columnNums[index];
            },
            getColumnDate(numbers){
                var arr = [];
