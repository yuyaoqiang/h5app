...
<script>
    ...
    export default {
        props: ['lottery','issueList','setting','removeOffsetHistoryEnd','selectType','substr','tableList'],
        data () {
            return {
                missingNumList:[],
                dialogTrend: false,
        ...
        methods: {
            ...
            getBitMissingNums(){
                ...
                for(var i in _this.issueList) {
                    ...
                    var nums = el.nums.substr(0,8).split(" ");
                    nums.sort();
                    list.push(el);
            ...
            buildMissing:function (nums) {
                ...
                switch(_this.selectType){
                    case 0:
                        ...
                        break;
                    case 1:
                            trendUtil.createNums_daxiao_11xuan5(nums,this.cacheMap,missingList);
                        break;
                    case 2:
                            trendUtil.createNums_jiou_11xuan5(nums,this.cacheMap,missingList);
                            break;
                    case 3:
                            trendUtil.createNums_zhihe_11xuan5(nums,this.cacheMap,missingList);
                        break;
                }
                return missingList;
