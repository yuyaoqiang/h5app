<template>
    <div>
        ...
        <section  class="recording-height" v-infinite-scroll="loadMore"
                 infinite-scroll-disabled="loading" infinite-scroll-distance="10" nfinite-scroll-immediate-check="false">
        ...
        <div v-if="tzDetails != null && dialogVisible">
            ...
            <div  class="recording-alert-main">
                <h4 class="recording-alert-title rem12">{{tzDetails.betRecord.gametypename}}-{{tzDetails.betRecord.issueno}} 期 开奖号码</h4>
                ...
                <div class="recording-alert">
                    ...
                    <dl>
                        <dt>是否中奖</dt>
                        <dd>{{tzDetails.betRecord.state == 4?(tzDetails.betRecord.iswin == 0?'未中奖':'中奖'):betRecord.STATE[tzDetails.betRecord.state]}}</dd>
                    </dl>
                    <dl>
                        <dt>中奖注数</dt>
                    ...
                    <dl>
                        <dt>中奖金额</dt>
                        <dd>{{tzDetails.betRecord.winmoney}}</dd>
                    </dl>
                </div>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            tzDetail(ID){
                ...
                betRecordApi.kgView(params,(res)=>{
            ...
            loadMore() {
                ...
                betRecordApi.findKGBetRecord(params,function(res){
            ...
            deleteOrder(unique,event){
                ...
                _this.lconfirm('您确定撤单吗？',null,() => {
                    ...
                    _this.lshowWait();
                    betRecordApi.kgCancelBet(params,(res) =>{
                        _this.lcloseWait();
