    ...
    <div>
        <header class="report-header-main">
            ...
            <div class="report-header">
                <div><b>{{data.ALLSSUM.allprofitloss>0?'+':''}}{{data.ALLSSUM.allprofitloss | fixedMoney}}</b></div>
                <p class="title_desc">总盈亏(元)</p>
            </div>
        </header>
    ...
    export default {
        ...
        methods: {
            ...
            search() {
                ...
                //_this.lshowWait()
                recordSearchApi.getUserDailyReportList(params, function (res) {
                    _this.lcloseWait();
                    if(res.code!=200){
