<template>
    <div  class="kg-lottery-main">
        <dl class="kg-betting-farm" v-if="kgLottery.playTypes!=null  && type.isZH  && titleView[type.id]!=null" v-for="type in kgLottery.playTypes">
            <dt>
            ...
            <dd v-for="(betType,index) in  type.betTypes"
                ...
                <div>
                    <h4 class="kg-farm-sum">{{betType.name}}<span class="red">x{{betType.odds}}</span></h4>
