<template>
    <div class="kg-lottery-main">
        <!-- <p v-if="kgLottery.showDesc!='色波'" class="lottery-wave-header">赔率: <span class="red">{{kgBetTypes[0].odds}}</span></p> -->

        <div class="kg-wave overflow-hidden kg-wave-half">
