<template>
    <div class="kg-lottery-main">
        <dl class="kg-betting-two" v-if="kgLottery.playTypes!=null && type.isLmp==true && titleView[type.id]!=null" v-for="type in kgLottery.playTypes">
            <dt>
