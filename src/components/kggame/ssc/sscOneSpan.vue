<template>
    <div  class="kg-lottery-main">
        <div class="kg-special-box">
            <section class="kg-betting-niu" v-if="kgLottery.playTypes!=null && type.isOneSpan==true" v-for="type in kgLottery.playTypes">
                ...
                <dl v-for="(betType,index) in  type.betTypes">
                    <dd  @click="toBetChoice(betType,betType.id)" :class="{'active':betType.active}">
                        <div>
                            ...
                            <!-- <p class="betting-money" v-if="betType.active">¥ {{kgLottery.totalMoney}} 元</!--> -->
                        </div>
                    </dd>
                </dl>
            </section>
