<template>
    <div  class="kg-lottery-main">
        <div class="kg-lottery-11x5">
            <section class="kg-betting-niu"  v-if="kgLottery.playTypes!=null && type.isLmp==true" v-for="type in kgLottery.playTypes">
                <h2  class="kg-betting-title"> {{type.desc}}</h2>
                <dl v-for="(betType,index) in  type.betTypes" v-if="betType.name>=0 == false">
