<template>
    <div  class="kg-lottery-main">
        <div class="kg-special-box">
            <section class="kg-betting-niu" v-if="kgLottery.playTypes!=null && type.isNum==true" v-for="type in kgLottery.playTypes">
                <h2 class="kg-betting-title">{{type.desc}}</h2>
                <dl v-for="(betType,index) in  type.betTypes" v-if="betType.name>=0">
